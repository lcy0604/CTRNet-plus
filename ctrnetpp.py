...
from .backbone_v2 import build_backbone
from .transformer import build_transformer
# from .swin_transformer import build_transformer
from .decoder_ffc import build_deconv_decoder, build_discriminator, build_feature_extractor,\
                                build_pixel_decoder, build_structure, build_ffc
from .loss_v3 import TextRemovalLoss, AdversarialLoss
...
class Pix2Seq(nn.Module):
    ...
    def forward(self, samples: NestedTensor, mask_label, gt, structure_im, structure_lbl, soft_masks):
        ...
        preds = {
            ...
            # 'mask': mask_pred,
            # 'mid_output': pixel_output, 
            # 'real_prob': real_prob,
            # 'fake_prob_D': fake_prob_D,
...
def build(args):
    ...
    model = Pix2Seq(backbone, transformer, structure_generator, pixel_decoder, feature_extractor, ffc_inapint, args.pixel_embed_dim, args.pix2pix_queries)
