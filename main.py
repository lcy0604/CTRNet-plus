...
def main(args):
    ...
    model, discriminator, criterion = build_model(args)
    ...
    optimizer = {'D': optimizer_D, 'G': optimizer_G}
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            model, discriminator, criterion, data_loader_train, optimizer, device, epoch,
