...
class FourierUnit(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, groups=1, spatial_scale_factor=None, spatial_scale_mode='bilinear',
        ...
        self.bn = FrozenBatchNorm2d(out_channels * 2) #torch.nn.BatchNorm2d(out_channels * 2)
...
class SpectralTransform(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, groups=1, enable_lfu=True, **fu_kwargs):
        ...
        self.conv1 = nn.Sequential(
            ...
            FrozenBatchNorm2d(out_channels // 2),
            nn.ReLU(inplace=True)
        )
        self.fu = FourierUnit(
...
class FFC_BN_ACT(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,
                 ...
                 norm_layer=FrozenBatchNorm2d, activation_layer=nn.Identity,
...
class FFCResNetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, n_downsampling=3, n_blocks=9, norm_layer=FrozenBatchNorm2d,
                 padding_type='reflect', activation_layer=nn.ReLU,
                 up_norm_layer=FrozenBatchNorm2d, up_activation=nn.ReLU(True),
    ...
    def forward(self, input):
        ...
        for i in range(len(self.model)):
            ...
            if i == 17 or i == 20 or i == 23:
                decode_feat.append(x)
        return x, middle_feat, decode_feat #self.model(input)